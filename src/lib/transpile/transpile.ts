...
function transformSource(blocks: BlockModel[], { insertDelay = true, insertShowAtEnd = true}: TransformSourceOptions) {
...
function transpile(blocks: BlockModel[], namespace?: Set<string>, options: TransformSourceOptions = {}) {
    if (!namespace) {
